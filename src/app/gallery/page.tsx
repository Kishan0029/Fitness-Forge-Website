...
export default function GalleryPage() {
  ...
  const gymInterior = [
    ...
    "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/832196e6-00da-48a4-8759-95d70ba5b49d/14-resized-1768320875297.webp?width=8000&height=8000&resize=contain"
  ];
